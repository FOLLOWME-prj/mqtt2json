...
_FTYPE = _descriptor.EnumDescriptor(
  name='FType',
  full_name='common.FType',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_sym_db.RegisterEnumDescriptor(_FTYPE)

FType = enum_type_wrapper.EnumTypeWrapper(_FTYPE)
...
DESCRIPTOR.enum_types_by_name['FType'] = _FTYPE
